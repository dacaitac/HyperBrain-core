 ...
 *
 * <p>Since ADR-039 the {@code TIME_BLOCK} executables live in the Tasks database as a
 * {@code Type = Time Block} value, so this same Tasks pass covers them — there is no separate
 * Time Blocks backfill any more.
 */
@Service
